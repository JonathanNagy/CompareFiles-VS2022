...
namespace CompareFilesVS2019
{
    ...
    internal sealed class CompareFilesWebCommand : CompareFilesCommandBase
    {
        ...
        private CompareFilesWebCommand(AsyncPackage package, OleMenuCommandService commandService) : base(package)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CompareFilesWebCommand(package, commandService);
        }
